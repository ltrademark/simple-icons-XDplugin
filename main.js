    ...
    [
      _c("div", { staticClass: "icon-search" }, [
        _c("input", {
          ...
          attrs: { type: "text", placeholder: "Search for a Brand" },
          domProps: { value: _vm.isearch },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.isearch = $event.target.value
            }
          }
        })
      ]),
      ...
      _c("p", [
        _c("small", [
          _c("i", [_vm._v(_vm._s(_vm.icons.length) + " brands loaded")])
        ])
      ]),
      _vm._v(" "),
      _c(
        ...
        _vm._l(_vm.filteredIcons, function(icon, idx) {
          return _c(
            "div",
            {
              key: idx,
              staticClass: "icon-grid--item",
              class: { selected: idx === _vm.selectedIcon },
            ...
            [
              _c(
                ...
                {
                  style:
                    _vm.$options.filters.contrast(icon.hex) === "color: #ffffff"
                      ? "filter: invert(1)"
                      : "",
                  attrs: {
                    href: _vm._f("svgname")(icon.title),
                    download: _vm._f("sanitizeURL")(
                      _vm._f("svgname")(icon.title)
                    ),
                    target: "_blank"
                  }
                },
              ...
              _vm._v(" "),
              _c("h3", { style: _vm._f("contrast")(icon.hex) }, [
                _vm._v(_vm._s(icon.title))
              ]),
              _vm._v(" "),
              _c("p", { style: _vm._f("contrast")(icon.hex) }, [
                _vm._v("#" + _vm._s(icon.hex))
              ])
            ]
          )
        }),
      ...
      _c(
        "transition",
        { attrs: { name: "popup", mode: "in-out" } },
        [
          _vm.selectedIcon !== null
            ? _c("selection-banner", {
                attrs: {
                  selected: _vm.selectedIcon,
                  "copy-action": _vm.copyToClipboard(
                    "#" + _vm.icons[_vm.selectedIcon].hex
                  )
                }
              })
            : _vm._e()
      ...
      _vm._v(" "),
      _c("transition", { attrs: { name: "popup", mode: "in-out" } }, [
        _vm.copied2Clipboard
          ? _c("div", { staticClass: "notification-toast copied" }, [
              _c("div", { staticClass: "bubble" }, [
                _c("p", [_vm._v("Copied to clipoard!")])
              ])
            ])
          : _vm._e()
      ]),
...
var staticRenderFns = [
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("p", [
      _vm._v("Data Courtesy of "),
      _c(
        "a",
        { attrs: { href: "https://simpleicons.org/", target: "_blank" } },
        [_vm._v("https://simpleicons.org/")]
      ),
      _vm._v(".")
    ])
  }
...
const styles = __webpack_require__(/*! ./style.css */ "./src/style.css");
...
const hello = __webpack_require__(/*! ./index.vue */ "./src/index.vue").default;
